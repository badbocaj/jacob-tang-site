...
function NavMapVisual() {
  ...
  return (
    <div className="flex items-center justify-center h-full">
      <svg viewBox="0 0 100 100" className="w-full max-h-[88px]" fill="none">
        {/* Range rings */}
...
function HoloSchematicsVisual() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full gap-2 py-1">
      ...
      <div className="font-mono text-[7px] text-cyan-400/50 tracking-[0.3em] animate-pulse">
        [LOADING...]
      </div>
      <div className="font-mono text-[6px] text-zinc-600 tracking-widest">
...
function MissionLogVisual() {
  ...
  return (
    <div className="font-mono overflow-hidden">
      <div className="text-violet-500/40 text-[6px] tracking-widest mb-1">
      ...
      {lines.map((line, i) => (
        <motion.div
          ...
          className="text-green-400/75 text-[7px] leading-[1.65] truncate"
        >
          {line}
        </motion.div>
      ))}
...
function MediaArchiveVisual() {
  ...
  return (
    <div className="relative w-full h-full overflow-hidden">
      ...
      >
        <div className="text-blue-400/45 text-[6px] tracking-widest mb-0.5">
          C:/ARCHIVE/BRAIN_ROT/
        </div>
        {FILM_LIST.map((film, i) => (
          <div key={i} className="text-blue-200/80 text-[7px] leading-[1.6]">
            {film}
          </div>
        ))}
      </div>
  ...
  return (
    <div className="w-full h-full flex flex-col">
      <canvas
        ...
        style={{ height: "56px" }}
      />
      <div className="font-mono text-[7px] text-amber-400/40 tracking-[0.18em] mt-1">
    ...
    >
      ...
      <div className="relative z-10 h-full flex flex-col">
        ...
        <div className="shrink-0 mb-1.5">
          <div className="font-mono text-[7px] tracking-[0.3em] text-zinc-600 uppercase">
            {zone.sublabel}
          </div>
          <div className="font-mono text-[9px] font-bold tracking-wider text-white/80">
            {zone.label}
          </div>
        </div>
        ...
        <div className="shrink-0 flex items-center justify-between mt-1">
          <span className="font-mono text-[7px] text-zinc-700 tracking-widest opacity-0 group-hover:opacity-100 transition-opacity">
            CLICK TO ACCESS
          </span>
...
function BootTerminal({ onDone }: { onDone: () => void }) {
  ...
  return (
    <div className="font-mono text-sm text-green-400 space-y-2 p-8 max-w-md mx-auto relative">
      <div
        ...
        <div className="p-6 relative z-20">
          <div className="flex items-start gap-3 mb-4">
            ...
            <div>
              ...
              <h2 className="font-mono text-lg text-white font-bold tracking-wide">
                {zone.sublabel}
              </h2>
            </div>
          </div>
          ...
          <div className="flex gap-2">
            <Link
              href={zone.href}
              className="flex-1 font-mono text-xs uppercase tracking-widest py-2.5 border border-white/20 text-zinc-400 bg-white/5 hover:bg-white/10 hover:text-white transition-all duration-150 text-center"
            >
              [ ENTER SECTOR ]
            </Link>
            <motion.button
              onClick={onClose}
              className="flex-1 font-mono text-xs uppercase tracking-widest py-2.5 border border-red-500/60 text-red-400 bg-red-950/20 hover:bg-red-500 hover:text-white transition-all duration-150 relative overflow-hidden group"
              whileHover={{ scale: 1.01 }}
              whileTap={{ scale: 0.98 }}
            >
  ...
  return (
    ...
    >
      ...
      <div className="relative z-30 flex items-center gap-6 px-6 py-2 border-t border-white/10 shrink-0">
        ...
        <span className="ml-auto font-mono text-[9px] text-zinc-700 tracking-widest">
          ALL SYSTEMS NOMINAL
        </span>
      </div>
    </motion.div>
    ...
    <div className="relative w-screen h-screen overflow-hidden bg-[#050505] flex items-center justify-center">
      ...
      <AnimatePresence>
        {phase === "sketch" && (
          ...
          >
            <RocketSketch />
            <p className="font-mono text-[10px] text-slate-600 tracking-[0.3em] uppercase mt-6 animate-pulse">
              initializing...
            </p>
          </motion.div>
        )}
