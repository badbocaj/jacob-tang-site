...
// ─────────────────────────────────────────────────────────────────────────────
// PROJECT REGISTRY — keep identical across all project pages
// ─────────────────────────────────────────────────────────────────────────────
...
const CURRENT_IDX = 1; // HPFRT is index 1
...
const PROJECT = {
  ...
  codename:  "HPFRT",
  subtitle:  "// HUMAN_POWERED_FLIGHT_RESEARCH_TEAM // STRUCTURES_DIVISION",
  status:    "ACTIVE :: 2024",

  // ── Column 1: Mission Objectives ──────────────────────────────────────────
  summary:
    "HPFRT is a student-built human-powered aircraft program targeting " +
    "sustained level flight under human power alone. As a Structures " +
    "Researcher on the team, the focus was on designing and validating the " +
    "primary wing spar and boom integration nodes — the joints that take the " +
    "highest bending and torsional loads in the airframe. The core problem: " +
    "getting the strength-to-weight ratio right on joints that can't be " +
    "tested to destruction before the aircraft is built.",

  specs: [
    { param: "AIRCRAFT_TYPE",  value: "MONOPLANE",      unit: "—"    },
    { param: "WINGSPAN",       value: "~12",            unit: "m"    },
    { param: "GROSS_WEIGHT",   value: "~115",           unit: "kg"   },
    { param: "PILOT_POWER",    value: "~350",           unit: "W"    },
    { param: "CRUISE_SPEED",   value: "~28",            unit: "km/h" },
    { param: "WING_LOADING",   value: "~5.2",           unit: "kg/m²"},
    { param: "SPAR_MATERIAL",  value: "CFRP_UNIDIRECT", unit: "—"    },
    { param: "RIB_MATERIAL",   value: "DEPRON_FOAM",    unit: "—"    },
    { param: "SKIN",           value: "MYLAR_12µm",     unit: "—"    },
  ...
  schematics: [
    {
      label:   "FIG_01 :: WING_BOOM_INTEGRATION_NODE",
      callout: "> CFRP_SPAR_CAP + FOAM_SHEAR_WEB // BONDED_JOINT_LAYUP_DETAIL",
      // src: "/images/hpfrt-node.png",
    },
    {
      label:   "FIG_02 :: RIB_STATION_CROSS_SECTION",
      callout: "> NACA_4412_PROFILE // RIB_PITCH_380mm // MYLAR_SKIN_TENSION",
      // src: "/images/hpfrt-rib.png",
    },
  ],

  // ── Column 3: Post-Mission Analysis ──────────────────────────────────────
  results: [
    { sym: ">", text: "Boom integration node redesigned after FEA flagged stress concentrations at the spar-to-boom shoulder radius." },
    { sym: ">", text: "Final joint geometry passed hand-calc check at 3× design load with a safety factor of 1.8 on the bond line." },
    { sym: "+", text: "NODE_MASS: 47 g — 22% reduction vs. prior design iteration through layup schedule optimization." },
    { sym: "+", text: "PREDICTED_DEFLECTION: 180 mm tip deflection at 1g maneuver load — within 5% of FEA prediction." },
    { sym: ">", text: "Structural test article fabricated and loaded to 1.5× limit load without failure. Full flight article in manufacturing." },
  ],
};
...
export default function HpfrtPage() {
  return (
            ...
            <div>
              ...
              <div className="space-y-2">
                {[
                  ...
                  { label: "DESIGN_REPORT",  href: "#" },
                  { label: "FEA_RESULTS",    href: "#" },
                ].map((link) => (
                  <a
                    key={link.label}
                    href={link.href}
