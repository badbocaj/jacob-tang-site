  ...
  return ( 
    <>
      ...
      <div className="absolute top-0 left-0 w-full flex justify-between items-center px-8 h-16 z-50 border-b border-white/5 bg-black/50 backdrop-blur-md">
        ...
        <div className="text-xs font-mono uppercase tracking-label text-white border border-white/20 px-3 py-1 rounded-full bg-black/50">
          EXIT_LOG // 02
        </div>
      </div>
      ...
      <div className="relative z-10 w-full h-full max-w-[100vw] pt-32 pb-16 flex items-center justify-center gap-12 lg:gap-16">
        ...
        <div className="w-full h-full md:w-1/2 lg:w-1/3 overflow-y-auto pr-8 relative z-20">
          ...
          <div className="pl-12 md:pl-24 mb-20 relative z-20">
            ...
            <p className="font-mono text-xs text-amber-500 uppercase tracking-label mt-4 opacity-70">
            ...
            {items.map((item) => (
              ...
              >
                ...
                <div className="w-full flex flex-col pt-0.5 relative z-20">
                  <span className="font-mono text-xs text-amber-500/80 tracking-label uppercase mb-1.5">
                  ...
                  <div className="mt-6 flex flex-wrap gap-2">
                    {item.tags.map((tag: any) => (
                      <span key={tag.slug} className="border border-white/10 bg-black/50 backdrop-blur-sm px-2 py-0.5 text-xs uppercase font-mono text-zinc-400">
                        {tag.name}
                      </span>
                    ))}
                  </div>
      ...
      >
        ...
        >
          ...
          <button 
            onClick={() => setActiveEntry(null)}
            className="absolute top-6 right-6 text-zinc-500 hover:text-amber-500 transition-colors z-50 flex items-center gap-2 font-mono text-xs uppercase tracking-label"
          >
            [X] Close Log
          </button>
          ...
          {activeEntry && (
            <div className="animate-in fade-in slide-in-from-bottom-2 duration-500 flex flex-col md:flex-row gap-12 h-full overflow-y-auto pr-4 custom-scrollbar">
              ...
              <div className="w-full md:w-1/3 pt-8">
                <p className="font-mono text-xs text-amber-500 tracking-label uppercase mb-4">
              ...
              <div className="w-full md:w-2/3 pt-8 flex flex-col gap-4">
                ...
                <div className="w-full aspect-video border border-white/5 bg-white/[0.02] rounded flex flex-col items-center justify-center font-mono text-xs text-zinc-600">
                  ...
                  <span className="text-xs mt-2 opacity-50">Drop images into frontmatter to populate</span>
                </div>
              </div>
